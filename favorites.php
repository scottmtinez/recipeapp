...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <div id="discover-search" style='margin-top: 10px;'>
        <form>
            ...
            if($result->num_rows > 0 ){
                 while($row = $result->fetch_assoc()){
                    ...
                    "
                                <div class='recipe-container'>
                                    ...
                                    <div class='recipe-info' id='holder'>
                                        ...
                                        <form method='POST' action='discover.php'>
                                            <input class='addToFav' type='submit' value='Discover New Recipes'>
                                        </form>
                                        ...
                                        <form method='POST' action='removeRecipes.php'>
                                            <input type='hidden' name='title' value='".$row["title"]."'>
                                            <input type='hidden' name='prepTime' value='".$row["PrepTime"]."'>
                                            <input type='hidden' name='cookTime' value='".$row["cookTime"]."'>
                                            <input type='hidden' name='recipeType' value='".$row["recipeType"]."'>
                                            ...
                                            <input type='hidden' name='dateAdded' value='".$row["dateAdded"]."'>
                                            <input type='hidden' name='ingredientes' value='".$row["ingredientes"]."'>
                                            <input class='removeRecipe' name='removeRecipe' type='submit' value='Remove Recipe'>
                                        </form>
                                    </div>
                        ...
                        echo "<h2 style='text-align: center;'>Users DB is empty. </h2>";
                    }
            }else{
