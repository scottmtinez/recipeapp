...
?>
    ...
    <?php
        ...
        //Insert into DB
            $sql = "INSERT INTO `favorites`(`title`, `PrepTime`, `cookTime`, `recipeType`, `originalCreator`, `ingredientes`, `dateAdded`, `yield`) 
            VALUES ('$title','$prepTime','$cookTime','$recipeType','$originalCreator','$ingredientes','$dateAdded','$yield')";

        //Checks to see if data was sent correctly
            if ($connection->query($sql) === TRUE) {
                echo "<h1 class='recipeAdded-alert' style='text-align: center;'>New Recipe has been added to your favorites list!</h1>";
                echo "<div style='text-align: center;'><a href='favorites.php' style='text-decoration: none;'>Go to your Favorites Page</a><div>";
            } else {
